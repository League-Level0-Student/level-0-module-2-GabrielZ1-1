...
void draw() {
   ...
   ellipse(50+x,100,50,50);
    //3. Make the ellipse a nice color, {done above}
...
//The reason I did -75 is because at x=725, the dot is centered at position 775 (centered at x+50) and since the width/diameter of the dot is 50, the radius is 25 so when it's centered at 775 (x=725), the dot is touching the end of the screen.
  if(x==800-75){
    playSound();
   }
}
